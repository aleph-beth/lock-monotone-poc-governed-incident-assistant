...
## Structure du dépôt
- [`Lock-Monotone-EN.md`](Lock-Monotone-EN.md) — Article de recherche consolidé (anglais).
- [`Lock-Monotone-FR.md`](Lock-Monotone-FR.md) — Article de recherche consolidé (français).
- [`Lock-Monotone.tex`](Lock-Monotone.tex) — Source LaTeX de l’article.
- [`docs/`](docs) — Documentation technique détaillée (contexte, cas d’usage, objectifs de sécurité, représentation intermédiaire, architecture, moteur de politiques, RAG contrôlé, auditabilité, scénarios d’attaque, checklist de préparation).
